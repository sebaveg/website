<template>
  <v-layout justify-center wrap row>
    <v-flex xs11 sm10 md9 lg7 xl6>
      <h2 class="display-1 font-weight-bold my-5 text-center">Geounity</h2>
      <p>
        Geounity es una app moderadora de debates, investigadora de comunidades
        y planificadora de acciones.
      </p>
      <p>
        Con esta app el usuario que se registre en el sistema podrá crear o
        contestar encuestas para su comunidad, ya sea, para su ciudad, para la
        provincia, el país, el continente o para todo el mundo.
      </p>
      <p>
        A su ves podrá abrir debates o entrar en alguno para dar su punto de vista sobre algún
        problema presente en su comunidad. Al crear un debate o
